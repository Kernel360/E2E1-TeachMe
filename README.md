...
|		|   |2.4강사명 검색||	
|		|   |2.5 키워드 검색||
|Review|1. 리뷰 작성|1.1 리뷰 작성 및 평점 등록||
|		|   |1.2 내가 등록한 리뷰 조회||
|		|   |1.3 리뷰 수정 및 평점 수정||
|	  |   |1.4 리뷰 삭제||
|Favor|1. 찜 하기|1.1 찜 등록||
|		|   |1.2 내가 찜한 강의 조회||
|		|   |1.3 찜 삭제||
|Admin|1. 데이터 관리|1.1 강의 리스트 크롤링||
|		|   |1.2 강의 상세 정보 크롤링||
|	  |2. 통계|2.1 총 리뷰 수 통계 조회||
|		|   |2.2 강의 별점 통계 조회||
|		|   |2.3 강의 리뷰 통계 조회||
</div>
